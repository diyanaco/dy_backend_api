...
# package_post_args.add_argument(
    # field2, type=str, help="User ID of package is required", required=True)
...
# package_post_query_args.add_argument(
#     field2, type=str, help="User ID of the package")
...
package_put_args.add_argument(field1, type=str, help="Name of Guardian")
# package_put_args.add_argument(field2, type=str, help="User ID of Guardian")
