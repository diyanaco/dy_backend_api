...
Revision ID: d60000c6a190
Revises: 3f7dafad9c70
Create Date: 2022-07-24 14:51:43.993929
...
revision = 'd60000c6a190'
down_revision = '3f7dafad9c70'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('dy_sms_student_class_link', sa.Column('left_id_testing', mysql.VARCHAR(length=50), nullable=True))
    ...
    op.drop_constraint(None, 'dy_sms_student_class_link', type_='foreignkey')
    op.create_foreign_key('dy_sms_student_class_link_ibfk_1', 'dy_sms_student_class_link', 'dy_sms_student', ['left_id_testing'], ['id'])
